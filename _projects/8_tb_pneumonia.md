...
{% include figure.liquid loading="eager" path="assets/img/neumonia3.png" title="Patients dashboard — scan history and results per patient" class="img-fluid rounded z-depth-1 mt-3" zoomable=true %}
