...
<div style="margin: 1.2rem 0;">
  <a href="https://hack-merced-4iq2.vercel.app/" target="_blank" style="display:inline-block;padding:0.5rem 1.3rem;background:var(--global-theme-color);color:#fff;border-radius:6px;font-weight:600;text-decoration:none;margin-right:0.6rem;">🌐 Live Site</a>
  <a href="https://github.com/HiramZ04/HackMerced" target="_blank" style="display:inline-block;padding:0.5rem 1.3rem;border:2px solid var(--global-theme-color);color:var(--global-theme-color);border-radius:6px;font-weight:600;text-decoration:none;">💻 Code on GitHub</a>
</div>
